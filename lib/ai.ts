  ...
  const messages = [
    ...
    },
    {
      ...
      content: `Cliente: ${input.clientName || "não informado"}\nObjetivo registrado: ${
        ...
        input.message
      }\n\nEvidências recuperadas:\n${evidenceText}\n\nResponda de forma objetiva. Primeiro use os dados já informados no cadastro e no histórico. Se o usuário trouxer intenção de mudança de hábitos, proponha um próximo passo prático e pergunte somente um detalhe comportamental que ainda não esteja no cadastro. Se faltam dados essenciais, pergunte somente o próximo dado mais importante. Se os dados forem suficientes, organize: síntese do caso, alertas, estrutura alimentar por refeições, substituições econômicas, lista de compras e pontos para validação profissional.`,
    },
  ];
